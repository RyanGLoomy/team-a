...
export default function WizardShell() {
  ...
  const Current = [
    <StepSize value={sel} onChange={setSel} pricing={pricing} onNext={next} key="s" />,
    <StepMaterials value={sel} onChange={setSel} pricing={pricing} onNext={next} onBack={back} key="m" />,
    <StepPayment value={pay} onChange={setPay} pricing={pricing} onNext={next} onBack={back} key="p" />,
    <StepIdentity value={idn} onChange={setIdn} onNext={next} onBack={back} key="i" />,
    <StepReview selections={sel} payment={pay} identity={idn} pricing={pricing} onBack={back} key="r" />,
  ][i];
